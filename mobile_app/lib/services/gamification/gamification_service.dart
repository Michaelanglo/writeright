...
class GamificationService extends ChangeNotifier {
  ...
  // // [STREAK FEATURE] int _streakDays = 0; // Tracks consecutive practice days
  ...
  int get xp => _xp;
  // // [STREAK FEATURE] int get streakDays => _streakDays; // Getter for streak days
  ...
  Future<void> loadProgress() async {
    ...
    // // [STREAK FEATURE] _streakDays = prefs.getInt('${prefix}gam_streak') ?? 0;
    ...
    try {
      ...
      final response = await http.put(
        ...
        body: jsonEncode({
          ...
          'streak_days': 0, // // [STREAK FEATURE] Was: _streakDays
      ...
      if (response.statusCode == 200) {
        ...
        if (data != null && data['streak_days'] != null) {
          // Update local streak from backend calculation
          _streakDays = (data['streak_days'] as num).toInt();
          await _persist();
        }
        */
      } else {
  ...
  Future<void> _persist() async {
    ...
    // // [STREAK FEATURE] await prefs.setInt('${prefix}gam_streak', _streakDays);
